...
class Solution {
	...
	private static final int[][] mMap = new int[20][20];
	private static final int[] mStructure = new int[5];
	...
	public static void main(String[] args) throws Exception {
		...
		System.setIn(new java.io.FileInputStream(
			"C:\\Users\\qq221\\Study\\Algorithm(JAVA,Python)\\JAVA\\src\\b형특강\\pro\\sample_input.txt"));
